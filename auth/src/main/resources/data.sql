...
INSERT INTO USERS (username, password, first_name, last_name, email, company_name, adress, pib, activated, accepted, blocked, blocked_postavljanje_oglasa, blocked_slanje_zahteva, canceled, owes, deleted, last_password_reset_date, salt)
	VALUES ('agent', '$2a$10$l.DxIIOAH4gwZ0H4KbB/ault2KsVQHUMY9CYXlJ7/yRnTOA6eIMU.', 'Nikola', 'Nikolic', 'admin@example.com', 'Kompanija1', 'Novosadska 1', 123456, true, true, false, false, false, 0, 0, false, '2017-10-01 18:57:58.508-07', 'los8gm50fd1');
INSERT INTO USERS (username, password, first_name, last_name, email, company_name, adress, pib, activated, accepted, blocked, blocked_postavljanje_oglasa, blocked_slanje_zahteva, canceled, owes, deleted, last_password_reset_date, salt)
	VALUES ('pera', '$2a$10$Fbq6q3mR.j4bgoAIKTJbYOr6ccjsMNZdmlKwRikJP8gLkx60jaSmG', 'Pera', 'Peric', 'pera@example.com', '', '', 0, false, false, false, false, false, 0, 0, false, '2017-10-01 21:58:58.508-07', 'a0s8hgy28h1');
