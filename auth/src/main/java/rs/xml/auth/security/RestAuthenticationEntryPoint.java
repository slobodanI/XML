...
import rs.xml.auth.controllers.AuthenticationController;
...
public class RestAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request,
    	...
    	logger.info("SR, UNAUTHORIZED attempt, IP: " +request.getRemoteAddr());
//    	System.out.println("UNAUTHORIZED attempt, IP: " +request.getRemoteAddr());
