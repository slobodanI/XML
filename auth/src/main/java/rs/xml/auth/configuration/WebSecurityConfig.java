...
import rs.xml.auth.security.RestAuthenticationEntryPoint;
import rs.xml.auth.security.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				...
				.antMatchers("/mesto").permitAll()
				.antMatchers("/marka").permitAll()
				.antMatchers("/gorivo").permitAll()
				.antMatchers("/klasa").permitAll()
				.antMatchers("/menjac").permitAll()
				.antMatchers("/model").permitAll()
				.antMatchers("/search").permitAll()
				.antMatchers("/oglas-search").permitAll()
